# CICD & Direct to Production
Source: https://docs.genguardx.ai/deploy-and-monitor/direct-to-production/
Markdown: https://docs.genguardx.ai/deploy-and-monitor/direct-to-production/index.md
