...
A report has three parts: a **data source**, **computation logic** (filtering, transformations, and metric calculations), and **visualization logic**. The job's data arrives as a dictionary of DataFrames, and you can compute in Pandas or PySpark.
