...
Source: https://docs.genguardx.ai/evaluate-and-approve/human-testing/
Markdown: https://docs.genguardx.ai/evaluate-and-approve/human-testing/index.md
...
Similar to this a pipeline can be tested/monitored post approval also. Visit [Deploy and Monitor](../../deploy-and-monitor/) section to know more on this.