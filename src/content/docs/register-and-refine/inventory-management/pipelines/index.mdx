---
title: Pipelines
description: How pipelines work in Corridor GGX — compose Models, RAGs, Prompts and Guardrails with orchestration logic. Covers pipeline types, anatomy, registration steps, testing, and risk assessment.
---

import { Aside, Badge, Card, CardGrid, LinkCard, LinkButton, Steps, Tabs, TabItem } from '@astrojs/starlight/components';
