...
description: Common questions about evaluating and monitoring GenAI applications in Corridor GGX — production monitoring, reports and dashboards, LLM-as-a-judge metrics, reusable assets, data and integrations, governance and testing, versioning, and human feedback.
---
...
Yes. Use the Corridor sync package to develop in your editor and push assets into the platform, keeping source control and review in your normal workflow.
...
<LinkCard title="Corridor Sync" href={`${import.meta.env.BASE_URL}register-and-refine/corridor_sync/`} />
</CardGrid>
