...
For detailed component-specific requirements, refer to the [Minimum Requirements](../minimum-requirements/) documentation.
...
:::caution[Do Not Use AWS Account Root User]
...
1. **Automated Provisioning Scripts**: Terraform and CloudFormation templates are available in the detailed installation guides ([EKS](aws-eks/), [ECS Fargate](aws-fargate/), [EC2](aws-ec2/)) that automate the creation of all required resources.
...
- **EKS Deployment**: See [EKS Installation Guide](aws-eks/) for Terraform templates and Kubernetes manifests
- **ECS Fargate Deployment**: See [Fargate Installation Guide](aws-fargate/) for CloudFormation templates and ECS task definitions
- **EC2 Deployment**: See [EC2 Installation Guide](aws-ec2/) for Terraform templates and AWS CLI scripts
...
[View EKS Installation Guide →](aws-eks/)
...
[View Fargate Installation Guide →](aws-fargate/)
...
[View EC2 Installation Guide →](aws-ec2/)
